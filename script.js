...
function updateProfileIconBtn() {
    // Intenta obtener el índice del icono guardado en localStorage
    let idx = localStorage.getItem('wikilabs_emoji_svg');
...
function renderCoursesPage() {
  ...
  if (coursesPage) {
    ...
    // Forzar actualización del icono después de renderizar el HTML
    setTimeout(updateProfileIconBtn, 0);
    ...
    // Actualizar el icono al volver de perfil (por si el usuario lo cambia)
    window.addEventListener('focus', updateProfileIconBtn);
  }
}
